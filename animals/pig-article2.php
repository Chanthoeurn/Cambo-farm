...
<body>
    ...
    <div class="container" style="margin-top:60px;">
        ...
        <div class="content">
            ...
            <div class="article">
                ...
                <p>ជាទូទៅ ពូជជ្រូកសំរាប់ផលិតកម្មជ្រូកបែបឧស្សាហកម្មភាគច្រើន គឺ ឡាចវ៉ាយ (Large white) ឡែនដ្រាស់ ...</p>
    ...
    <div class="page">
        <div class="pagination">
            <a href="../animals/pig-article1.php">&laquo;</a>
            <a href="../animals/pig-article1.php">1</a>
            <a href="../animals/pig-article2.php" class="active">2</a>
            <a href="#">3</a>
            <a href="#">4</a>
            <a href="#">5</a>
            <a href="#">&raquo;</a>
