...
<body>
    ...
    <div class="sub-menu">
        ...
        <div class="title">
            <h1 style="padding: 20px;color:black; font-size: 30px ;font-family: 'Nokora', serif;">សត្វមាន់</h1>
        </div>
        <div class="content">
            <div class="img">
                <img src="../img/chicken/chick.jpg" alt="">
            </div>
            <div class="article">
                <h5>បច្ចេកទេសចិញ្ចឹមមាន់ស្រុកសម្រាប់ទីផ្សារ</h5>
                <p>ជើងទ្រូងកំពស់ពីដី០,៥ម 
                ...
                <a href="../contents/article-content-chicken1.php">ចុចអានបន្ត...</a>
            </div>
        </div>
